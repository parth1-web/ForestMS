...
{
    public class ChiranBillReportIndexViewModel
    {
        ...
        public List<ChiranBillReportDetails> chiran_bill_datas = new List<ChiranBillReportDetails>();
    }

    public class ChiranBillReportDetails
    {
